...
echo ""
echo "=== ACTION REQUIRED: Configure your LLM models ==="
echo ""
echo "Edit /etc/mango/config.yaml and fill in the provider, model, and"
echo "api_key for at least one agent. Example (Anthropic):"
echo ""
echo "  agents:"
...
echo ""
echo "=== Next steps ==="
echo "  1. Edit config:  sudo nano /etc/mango/config.yaml"
echo "  2. Enable:       sudo systemctl enable mango"
echo "  3. Start:        sudo systemctl start mango"
echo "  4. Check logs:   journalctl -u mango -f"
echo ""
echo "Once running and configured:"
echo "  mango status"
